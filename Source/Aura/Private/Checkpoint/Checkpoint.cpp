...
void ACheckpoint::OnSphereOverlapped(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor,
...
void ACheckpoint::BeginPlay()
{
	...
	Sphere->OnComponentBeginOverlap.AddDynamic(this, &ACheckpoint::OnSphereOverlapped);
}

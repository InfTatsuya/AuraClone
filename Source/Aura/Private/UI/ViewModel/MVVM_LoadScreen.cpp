...
{
	LoadSlots[Slot]->SetWidgetWitcherIndex.Broadcast(1);
}
...
void UMVVM_LoadScreen::PlayButtonPressed()
{
	...
	if(AuraGameMode && IsValid(SelectedSlot))
	{
...
void UMVVM_LoadScreen::SetNumLoadSlots(int32 InNumLoadSlot)
{
	UE_MVVM_SET_PROPERTY_VALUE(NumLoadSlots, InNumLoadSlot);
}
